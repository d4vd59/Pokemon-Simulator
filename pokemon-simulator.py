    ...
    for special_name, pack_chances in drop_chances.items():
        ...
        if random.random() < chance:
            ...
            if data:
                ...
                rarity = "🌟 Legendary" if data["id"] in legendary_ids else ("✨ Rare" if data["id"] in rare_ids else "Common")
...
def show_card(name, rarity, img_url):
    ...
    fg_color = color_overrides.get(name, "#FF1493" if rarity == "🌟 Legendary" else "black")
    text = f"{name}\n{rarity}\n💵 {price} €"
